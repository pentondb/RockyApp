...
namespace Rocky.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            IEnumerable<Product> objList = _db.Product.Include("Category").Include("ApplicationType");
        ...
        public IActionResult Delete(int? id)
        {
            ...
            var product = _db.Product.Include("Category").Include("ApplicationType").FirstOrDefault(u => u.Id == id);
